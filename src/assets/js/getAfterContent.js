 ...
 * 
 * <b>Зачем???</b>
 * Здоровому человеку это скорей всего никогда не понадобится, 
 * а нездоровый захотел определить цвета в SCSS, а потом этими цветами в canvas рисовать. 
 ...
 */
export const getAfterContent = (id) => {
